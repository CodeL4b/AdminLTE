...
<section class="col-md-12">
	<h4>Add New Shipper Information</h4>
</section>
<div> . </div>	
        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="shipper_frm" action="{{route('shipper.store')}}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@csrf
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="bin_vat_no"  class="form-control" id="bin_vat_no" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">ERC No. </label>
							<input type="text" spellcheck="false" name="erc_no"  class=" form-control" id="erc_no" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">IRC No. </label>
							<input type="text" spellcheck="false" name="irc_no"  class="form-control" id="irc_no" value=""  />
						</div>
