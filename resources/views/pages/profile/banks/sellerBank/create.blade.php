        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="shipper_frm" action="{{route('sellerBank.store')}}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@csrf
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="acc_name"  class="validate[required] form-control" id="acc_name" value=""  autofocus/>
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1"> Account Number <i style="color:red;font-size:15px;">*</i> </label>
							<input type="text" spellcheck="false" name="acc_num"  class="validate[required] form-control" id="acc_num" value=""  autofocus/>
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1"> Bank Name  </label>
							<input type="text" spellcheck="false" name="name"  class="form-control" id="name" value=""  autofocus/>
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">Branch Name</label>
							<input type="text" spellcheck="false" name="branch"  class="form-control" id="branch" value=""  />
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="bin_num"  class=" form-control" id="bin_num" value=""  />
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="currency"  class="validate[required,minSize[3],maxSize[3]] form-control" id="currency" value=""  autofocus/>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="phone_no" id="phone_no" class="form-control" value="" />
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">RM Name </label>
							<input type="text" name="rm_name"  class="form-control" id="rm_name" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">RM Mobile </label>
							<input type="text" spellcheck="false" name="rm_mobile_num"  class=" form-control" id="rm_mobile_num" value=""  autofocus/>
						</div>	
