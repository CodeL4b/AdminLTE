        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="product_frm" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@csrf
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="code_sku"  class="validate[required] form-control" id="code_sku" value=""  autofocus/>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="hs_code_bd"  class="form-control" id="hs_code_bd" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">H.S. Code </label>
							<input type="text" spellcheck="false" name="hs_code"  class=" form-control" id="hs_code" value=""  />
						</div>
						...
						<div class="row">
                      		<div class="col-sm-3 imgUp">
                    			...
                    			<label class="btn btnn-primary">
                            		Upload Image
                            		<input type="file" class="uploadFile img" value="Upload Photo" name="photo" id="photo" style="width: 0px;height: 0px;overflow: hidden;">
                                </label>
                      		</div>
                        </div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="unit"  class="form-control" id="unit" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Net Weight</label>
							<input type="text" spellcheck="false" name="net_weight"  class=" form-control" id="net_weight" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Gross Weight </label>
							<input type="text" spellcheck="false" name="gross_weight"  class="form-control" id="gross_weight" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">CBM Weight</label>
							<input type="text" spellcheck="false" name="cbm" id="cbm" class="form-control" value="" />
						</div>
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="product_cost"  class="form-control" id="product_cost" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Packing Cost</label>
							<input type="text" spellcheck="false" name="packing_cost"  class=" form-control" id="packing_cost" value=""  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Cash Incentive</label>
							<input type="text" spellcheck="false" name="cash_incentive"  class="form-control" id="cash_incentive" value=""  />
						</div>
