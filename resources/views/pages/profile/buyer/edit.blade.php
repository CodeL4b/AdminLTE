...
<section class="col-md-12">
	<h4>Update Buyer Information</h4>
</section>
<div> . </div>	
        ...
        <div class="col-md-12">
          <!-- general form elements -->
			<div class="box box-primary">
				...
				<form id="shipper_frm" action="{{route('buyer.update', $buyer->id)}}" method="post" enctype="multipart/form-data">
					<div class="box-body">
						@csrf
						@method('PUT')
						...
						<div class="form-group">
							...
							<input type="text" spellcheck="false" name="business_name"  class="validate[required] form-control" id="business_name" value="{{$buyer->business_name}}"  autofocus/>
						</div>
						...
						<div class="form-group">
							...
							<input type="email" spellcheck="false" name="email" id="email" class="form-control" value="{{$buyer->email}}" />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">FAX No. </label>
							<input type="text" spellcheck="false" name="fax_no" id="fax_no" class="form-control" value="{{$buyer->fax_no}}" />
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">Phone Number </label>
							<input type="text" name="phone_no"  class="form-control" id="phone_no" value="{{$buyer->phone_no}}"  />
						</div>

						<div class="form-group">
							<label for="exampleInputEmail1">Contact Person </label>
							<input type="text" spellcheck="false" name="contact_person"  class=" form-control" id="contact_person" value="{{$buyer->contact_person}}"  autofocus/>
						</div>		
